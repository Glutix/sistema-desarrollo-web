                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <select class="form_control select-picker" name="tipo_documento" id="tipo_documento" required>
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <select id="tipo_persona" class="form_control select-picker" data-live-search="True" name="tipo_persona" required>
