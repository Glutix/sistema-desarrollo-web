...
<head>
    ...
    <title>ITElectronica | www.electronica.com.ar</title>
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-mini"><b>I</b>Electronica</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>IElectronica</b></span>
            </a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        www.iElectronica.com.ar - Desarrollando Software
