...
<head>
  ...
  <title>Apex Tech | www.apex-tech.com.ar</title>
  ...
  <!--Completar esto hasta el cierre del HEAD-->
  <!--Datatables-->
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index2.html" class="logo">
        ...
        <span class="logo-mini"><b>Apex</b>Tech</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Apex Tech</b></span>
      </a>
            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  ...
                  <p>
                    www.apex-tech.com.ar - Lo mejor en calidad y rendimiento
        ...
        <ul class="sidebar-menu">
          ...
          <li>
            <a href="#">
              ...
              <small class="label pull-right bg-yellow">Apex Tech</small>
            </a>
          </li>
